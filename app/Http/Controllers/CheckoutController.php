...
class CheckoutController extends Controller
{
    ...
    {
        $item = Transaction::with(['transaction_details', 'travel_package', 'users'])->findOrFail($id);
    ...
    public function remove(Request $request, $detail_id)
    {
        ...
        return redirect()->route('checkout', $item->transaction_id)->with('create', 'Data Berhasil Dihapus!!');
    }
