...
<div class="container">
    <nav class="row navbar navbar-expand-lg navbar-light bg-white">
      <a href="{{ route('home') }}" class="navbar-brand">
        <img src="{{ url('frontend/image/koperku.png') }}" alt="Logo" />
      </a>
      ...
      <div class="collapse navbar-collapse" id="navb">
       ...
       @guest
        ...
        <!-- Desktop Button -->
        <form class="form-inline my-2 my-lg-0 d-none d-md-block d-sm-block">
       ...
       @auth
        ...
        <!-- Desktop Button -->
        <form class="form-inline my-2 my-lg-0 d-none d-md-block d-sm-block" action="{{ url('logout') }}"method="POST">
          @csrf
